...
const MAPPINGS = {
  ...
  "places-menupopup.js": "browser/components/places/content/places-menupopup.js",
  ...
  for (let line of fileData) {
    ...
    if (match) {
      let sourceFile = match[1]
        ...
        .replace("chrome://browser/content/screenshots/", "browser/components/screenshots/content/")
        .replace("chrome://browser/content/tabbrowser/", "browser/components/tabbrowser/content/")
