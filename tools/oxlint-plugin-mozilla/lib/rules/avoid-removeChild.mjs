/**
 * @file Reject using element.parentNode.removeChild(element) when element.remove() can be used
 *   instead.
 * @license
...
export default {
  meta: {
    ...
    messages: {
      useRemove: "use element.remove() instead of element.parentNode.removeChild(element)",
      useFirstChildRemove:
