/**
 * @file Reject use of lazy getters for modules that's loaded early in the startup process and not
 *   necessarily be lazy.
 * @license
    ...
    return {
      ...
      CallExpression(node) {
        ...
        if (
          ...
          helpers.getIsTopLevelAndUnconditionallyExecuted(context.sourceCode.getAncestors(node))
        ) {
          ...
          checkMixed(loadedModules, context, node, "eager", resourceURINode.value);
        }
        ...
        if (callerSource === "ChromeUtils.defineESModuleGetters") {
          ...
          for (let prop of obj.properties) {
            ...
            checkMixed(loadedModules, context, node, "lazy", resourceURINode.value);
          }
        }
      },
    };
