/**
 * @file Reject use of XPCOMUtils.generateQI and JS-implemented QueryInterface methods in favor of
 *   ChromeUtils.
 * @license
...
export default {
  meta: {
    ...
    messages: {
      ...
      noXpcomUtilsGenerateQI: "Please use ChromeUtils.generateQI instead of XPCOMUtils.generateQI",
    },
    schema: [],
    type: "suggestion",
  },
