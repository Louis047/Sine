/**
 * @file Require use of static imports where possible.
 * @license
...
export default {
  meta: {
    ...
    fixable: "code",
    messages: {
      useStaticImport: "Please use static import instead of ChromeUtils.importESModule",
    },
    schema: [],
    type: "suggestion",
  },
          ...
          context.report({
            ...
            fix(fixer) {
              return fixer.replaceText(
                node.parent,
                `import ${importItemSource} from ${sourceCode.getText(callee.parent.arguments[0])}`
              );
            },
          });
        }
